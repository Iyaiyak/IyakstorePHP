                    ...
                    <div class="table-responsive">
                        <?php 
                            ...
                            if(isset($_GET['id_del'])){ 
                                ...
                                $img = "SELECT * FROM product WHERE id = '".$iddel."'";
                        ...
                        <table class="table table-striped table-bordered table-hover" id="saya">
                            ...
                            <tbody>
                                <?php
                                include 'connection.php';
                                $view = mysqli_query($conn, "SELECT * FROM product");
                                ...
                                while ($rows = mysqli_fetch_array($view)) { ?>
                                    <tr>
                                        ...
                                        <a href="?id_del=<?php echo $rows['id']?>" onclick="return confirm('Sure to delete Product ?')">DELETE</a>
                                        </td>
